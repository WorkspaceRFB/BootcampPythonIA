...
# idadeAutorizada = int(20)
# if idade < idadeAutorizada:
#     # print(nome, 'você é menor de idade.')
#     print(f'Olá {nome}, sua idade é {idade} e você não está autorizado para acessar esse conteúdo.')
# else:
#     # print('Olá', nome, 'sua idade é', idade, 'e você é maior de idade.')
